package com.fund.transfer.api.gateway.schema;
...
@Slf4j
@Component("schemaInitializer") // named bean — Liquibase will depend on this
public class SchemaInitializer implements InitializingBean { // NOT ApplicationRunner
    ...
    // runs during bean initialization — before Liquibase
    @Override
    public void afterPropertiesSet() {
        log.info("╔══════════════════════════════════════════╗");
        log.info("║   Gateway Schema Initialization...       ║");
        log.info("╚══════════════════════════════════════════╝");
